      ...
      <div className="relative">
        <div className="flex items-start justify-between mb-3 gap-3">
          <div className="flex items-center gap-1.5 min-w-0">
            <h3 className="text-base font-semibold text-surface-100 group-hover:text-emerald-200 transition-colors leading-snug truncate">{skill.name}</h3>
            <button
              onClick={handleCopy}
              className="p-1 rounded hover:bg-surface-800/60 text-surface-500 hover:text-emerald-400 transition-all cursor-pointer opacity-0 group-hover:opacity-100 focus:opacity-100 shrink-0"
